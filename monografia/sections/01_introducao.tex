...
\begin{enumerate}
    \item Identificar, por meio de revisão bibliográfica, as principais abordagens arquiteturais utilizadas em plataformas de e-commerce, como arquitetura monolítica, microsserviços e orientada a eventos, analisando seus \textit{trade-offs} conforme apresentados na literatura.
